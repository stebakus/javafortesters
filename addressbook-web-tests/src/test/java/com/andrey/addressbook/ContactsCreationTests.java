...
public class ContactsCreationTests {
  ...
  public void testContactsCreationTests() throws Exception {
    gotoAddNewPage();
    fillContactForm(new ContactsData("Andrey", "Begishev", "272 Canaveral Beach Blvd, Cape Canaveral, FL, 32920, USA", "3214192300", "andreybegishev@gmail.com"));
  ...
  private void fillContactForm(ContactsData contactsData) {
    ...
    wd.findElement(By.name("mobile")).sendKeys(contactsData.getPhonenumber());
    wd.findElement(By.name("email")).click();
    wd.findElement(By.name("email")).clear();
    wd.findElement(By.name("email")).sendKeys(contactsData.getEmailaddress());
  }
